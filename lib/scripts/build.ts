...
const entries: BuildEntry[] = [{ entry: "src/main.ts", output: "dist/main.js" }];
...
async function build(): Promise<void> {
	try {
		...
		// Copy action.yml
		await copyFile("action.yml", `${releaseDir}/action.yml`);
		...
		console.log(`✓ Copied ${distFiles.length} dist files`);
